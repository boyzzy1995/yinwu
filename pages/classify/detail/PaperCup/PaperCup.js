...
Page({
  ...
  data: {
    productList: {},
    SpecificationType: ['7盎司纸杯（约200ml）', '9盎司纸杯（约250ml）'],
    SpecificationTypeIndex: 0,
    Amount:['1000','2000','5000','10000','20000','50000','100000'],
    AmountIndex:0,
  },
  /**
   * 生命周期函数--监听页面加载
  ...
  gotoPrint: function (e) {
    ...
    arry = [
      "规格型号:" + me.data.SpecificationType[me.data.SpecificationTypeIndex]
    ];
    remark = arry.join("#");
    submitData = {
      ...
      remark: remark,
      addressId: addressId,
      amount: me.data.Amount[me.data.AmountIndex]
    }
    if (t) {
